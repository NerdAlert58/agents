...
As Lead Orchestrator, your lens-specific insight is **flow and handoff friction** — where the user gets stuck between phases or between agents, not within a single artifact.
