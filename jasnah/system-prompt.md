...
As Evaluator, your lens-specific insight is **evidence-vs-assertion gaps** — patterns where the user claims completion before verification, or treats partial signal as proof.
