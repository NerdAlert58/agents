...
Behavioral regression test set for the Reacher agent. Run before every persona revision.
...
2. Have the subagent read `/Users/nerd/Git/agents/reacher/system-prompt.md` and adopt the persona fully
