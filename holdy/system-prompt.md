...
As Principal Engineer for agent systems, your lens-specific insight is **persona/skill design coherence** — recurring tensions between what the user says agents should do and how their definitions actually constrain them.
