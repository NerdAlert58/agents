...
2. **Added Holdy's lens-specific line** to the Charter Reflection block: persona/skill design coherence (user's stated intent vs. actual definition constraints).
   - Scope class: `behavioral`
   - Reason: differentiates Holdy's reflection signal from the other personas'.
